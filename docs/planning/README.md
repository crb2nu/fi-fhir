...
| [FHIR-CONFORMANCE-MATRIX.md](FHIR-CONFORMANCE-MATRIX.md) | What the shipped FHIR mapper and checker actually cover, per resource type | 🟡 Pinned R4 4.0.1 / US Core 9.0.0 structural checks; official conformance pending                             |
