...
export type HomeRecentSessionsQueryVariables = Exact<{ [key: string]: never; }>;


export type HomeRecentSessionsQuery = { __typename?: 'Query', integrationSessions: Array<{ __typename?: 'IntegrationSession', id: string, name: string, updatedAt: string, runs: Array<{ __typename?: 'SessionRun', id: string, status: string }> }> };
...
export type OperatorPrincipalFieldsFragment = { __typename?: 'OperatorPrincipal', id: string, kind: string, authMethod: string, roles: Array<string> };

export type OperatorPageInfoFieldsFragment = { __typename?: 'OperatorPageInfo', hasNextPage: boolean, endCursor: string | null };

export type OperatorDeadLetterFieldsFragment = { __typename?: 'OperatorDeadLetter', attemptId: string, active: boolean, failureCode: string, failureDetail: string, failedAt: string, replayCount: number, lastReplayedAt: string | null, resolution: string, resolvedAt: string | null };

export type OperatorDestinationDeliveryFieldsFragment = { __typename?: 'OperatorDestinationDelivery', transport: string, outcome: string, endpointAdvisory: string, fhirResourceTypes: Array<string>, fhirEntryCount: number, fhirOutcomeCodesAdvisory: Array<string> };

export type OperatorAttemptFieldsFragment = { __typename?: 'OperatorDeliveryAttempt', tenantId: string, attemptId: string, parentAttemptId: string | null, receiptId: string, eventId: string, traceId: string, route: string, action: string, status: string, attemptCount: number, recordedAt: string, scheduledAt: string, completedAt: string | null, lastErrorCode: string, lastErrorDetail: string, outboxStatus: string, topic: string, leaseOwner: string, leaseExpiresAt: string | null, destination: { __typename?: 'IntegrationPreviewDestination', artifactId: string, revisionId: string, digest: string, class: string }, deadLetter: { __typename?: 'OperatorDeadLetter', attemptId: string, active: boolean, failureCode: string, failureDetail: string, failedAt: string, replayCount: number, lastReplayedAt: string | null, resolution: string, resolvedAt: string | null } | null, deliveries: Array<{ __typename?: 'OperatorDestinationDelivery', transport: string, outcome: string, endpointAdvisory: string, fhirResourceTypes: Array<string>, fhirEntryCount: number, fhirOutcomeCodesAdvisory: Array<string> }> };

export type OperatorReceiptFieldsFragment = { __typename?: 'OperatorReceipt', tenantId: string, receiptId: string, status: string, recordedAt: string, correlationId: string, rawRetentionMode: string, reason: string, eventCount: number, attemptCount: number, failedAttemptCount: number, deadLetterCount: number, integrationRevision: { __typename?: 'IntegrationArtifactRevision', artifactId: string, revisionId: string, digest: string }, principal: { __typename?: 'OperatorPrincipal', id: string, kind: string, authMethod: string, roles: Array<string> } };

export type OperatorAuditFieldsFragment = { __typename?: 'OperatorAuditRecord', auditId: string, attemptId: string, eventKind: string, attemptCount: number, reason: string, recordedAt: string, detail: unknown, principal: { __typename?: 'OperatorPrincipal', id: string, kind: string, authMethod: string, roles: Array<string> } };

export type OperatorDeploymentFieldsFragment = { __typename?: 'OperatorDeployment', state: string, version: number, releaseId: string | null, health: string, validationPassed: boolean, validationExpiresAt: string | null, updatedReason: string, updatedAt: string, definitionRevision: { __typename?: 'IntegrationArtifactRevision', artifactId: string, revisionId: string, digest: string }, updatedBy: { __typename?: 'OperatorPrincipal', id: string, kind: string, authMethod: string, roles: Array<string> } };

export type OperatorReceiptsQueryVariables = Exact<{
  filter: InputMaybe<OperatorReceiptFilter>;
  page: InputMaybe<OperatorPageInput>;
}>;


export type OperatorReceiptsQuery = { __typename?: 'Query', operatorReceipts: { __typename?: 'OperatorReceiptConnection', nodes: Array<{ __typename?: 'OperatorReceipt', tenantId: string, receiptId: string, status: string, recordedAt: string, correlationId: string, rawRetentionMode: string, reason: string, eventCount: number, attemptCount: number, failedAttemptCount: number, deadLetterCount: number, integrationRevision: { __typename?: 'IntegrationArtifactRevision', artifactId: string, revisionId: string, digest: string }, principal: { __typename?: 'OperatorPrincipal', id: string, kind: string, authMethod: string, roles: Array<string> } }>, pageInfo: { __typename?: 'OperatorPageInfo', hasNextPage: boolean, endCursor: string | null } } };

export type OperatorMessageTraceQueryVariables = Exact<{
  receiptId: Scalars['ID']['input'];
}>;


export type OperatorMessageTraceQuery = { __typename?: 'Query', operatorMessageTrace: { __typename?: 'OperatorMessageTrace', receipt: { __typename?: 'OperatorReceipt', tenantId: string, receiptId: string, status: string, recordedAt: string, correlationId: string, rawRetentionMode: string, reason: string, eventCount: number, attemptCount: number, failedAttemptCount: number, deadLetterCount: number, integrationRevision: { __typename?: 'IntegrationArtifactRevision', artifactId: string, revisionId: string, digest: string }, principal: { __typename?: 'OperatorPrincipal', id: string, kind: string, authMethod: string, roles: Array<string> } }, events: Array<{ __typename?: 'OperatorEvent', eventId: string, receiptId: string, eventType: string, sourceMessageId: string, correlationId: string, classification: string, recordedAt: string, payloadTruncated: boolean, payloadFields: Array<{ __typename?: 'OperatorPayloadField', path: string, kind: string, repeated: boolean }> }>, lineage: Array<{ __typename?: 'OperatorLineage', lineageId: string, receiptId: string, eventId: string, traceId: string, correlationId: string, sourceMessageId: string, recordedAt: string, artifactRevisions: { __typename?: 'IntegrationExecutionArtifactRevisions', source: { __typename?: 'IntegrationArtifactRevision', artifactId: string, revisionId: string, digest: string }, profile: { __typename?: 'IntegrationArtifactRevision', artifactId: string, revisionId: string, digest: string }, workflow: { __typename?: 'IntegrationArtifactRevision', artifactId: string, revisionId: string, digest: string } }, routes: Array<{ __typename?: 'OperatorRoute', route: string, matched: boolean, skipped: boolean, skipReason: string | null, transformCount: number, plannedActions: Array<string>, diagnosticCodes: Array<string> }>, diagnostics: Array<{ __typename?: 'OperatorDiagnostic', severity: string, stage: string, code: string, path: string | null, classification: string }> }>, attempts: Array<{ __typename?: 'OperatorDeliveryAttempt', tenantId: string, attemptId: string, parentAttemptId: string | null, receiptId: string, eventId: string, traceId: string, route: string, action: string, status: string, attemptCount: number, recordedAt: string, scheduledAt: string, completedAt: string | null, lastErrorCode: string, lastErrorDetail: string, outboxStatus: string, topic: string, leaseOwner: string, leaseExpiresAt: string | null, destination: { __typename?: 'IntegrationPreviewDestination', artifactId: string, revisionId: string, digest: string, class: string }, deadLetter: { __typename?: 'OperatorDeadLetter', attemptId: string, active: boolean, failureCode: string, failureDetail: string, failedAt: string, replayCount: number, lastReplayedAt: string | null, resolution: string, resolvedAt: string | null } | null, deliveries: Array<{ __typename?: 'OperatorDestinationDelivery', transport: string, outcome: string, endpointAdvisory: string, fhirResourceTypes: Array<string>, fhirEntryCount: number, fhirOutcomeCodesAdvisory: Array<string> }> }>, audit: Array<{ __typename?: 'OperatorAuditRecord', auditId: string, attemptId: string, eventKind: string, attemptCount: number, reason: string, recordedAt: string, detail: unknown, principal: { __typename?: 'OperatorPrincipal', id: string, kind: string, authMethod: string, roles: Array<string> } }> } | null };

export type OperatorDeliveryAttemptQueryVariables = Exact<{
  attemptId: Scalars['ID']['input'];
}>;


export type OperatorDeliveryAttemptQuery = { __typename?: 'Query', operatorDeliveryAttempt: { __typename?: 'OperatorDeliveryAttempt', tenantId: string, attemptId: string, parentAttemptId: string | null, receiptId: string, eventId: string, traceId: string, route: string, action: string, status: string, attemptCount: number, recordedAt: string, scheduledAt: string, completedAt: string | null, lastErrorCode: string, lastErrorDetail: string, outboxStatus: string, topic: string, leaseOwner: string, leaseExpiresAt: string | null, destination: { __typename?: 'IntegrationPreviewDestination', artifactId: string, revisionId: string, digest: string, class: string }, deadLetter: { __typename?: 'OperatorDeadLetter', attemptId: string, active: boolean, failureCode: string, failureDetail: string, failedAt: string, replayCount: number, lastReplayedAt: string | null, resolution: string, resolvedAt: string | null } | null, deliveries: Array<{ __typename?: 'OperatorDestinationDelivery', transport: string, outcome: string, endpointAdvisory: string, fhirResourceTypes: Array<string>, fhirEntryCount: number, fhirOutcomeCodesAdvisory: Array<string> }> } | null };

export type OperatorDeliveryAttemptsQueryVariables = Exact<{
  filter: InputMaybe<OperatorAttemptFilter>;
  page: InputMaybe<OperatorPageInput>;
}>;


export type OperatorDeliveryAttemptsQuery = { __typename?: 'Query', operatorDeliveryAttempts: { __typename?: 'OperatorDeliveryAttemptConnection', nodes: Array<{ __typename?: 'OperatorDeliveryAttempt', tenantId: string, attemptId: string, parentAttemptId: string | null, receiptId: string, eventId: string, traceId: string, route: string, action: string, status: string, attemptCount: number, recordedAt: string, scheduledAt: string, completedAt: string | null, lastErrorCode: string, lastErrorDetail: string, outboxStatus: string, topic: string, leaseOwner: string, leaseExpiresAt: string | null, destination: { __typename?: 'IntegrationPreviewDestination', artifactId: string, revisionId: string, digest: string, class: string }, deadLetter: { __typename?: 'OperatorDeadLetter', attemptId: string, active: boolean, failureCode: string, failureDetail: string, failedAt: string, replayCount: number, lastReplayedAt: string | null, resolution: string, resolvedAt: string | null } | null, deliveries: Array<{ __typename?: 'OperatorDestinationDelivery', transport: string, outcome: string, endpointAdvisory: string, fhirResourceTypes: Array<string>, fhirEntryCount: number, fhirOutcomeCodesAdvisory: Array<string> }> }>, pageInfo: { __typename?: 'OperatorPageInfo', hasNextPage: boolean, endCursor: string | null } } };

export type OperatorDeadLettersQueryVariables = Exact<{
  activeOnly: InputMaybe<Scalars['Boolean']['input']>;
  page: InputMaybe<OperatorPageInput>;
}>;


export type OperatorDeadLettersQuery = { __typename?: 'Query', operatorDeadLetters: { __typename?: 'OperatorDeadLetterConnection', nodes: Array<{ __typename?: 'OperatorDeadLetter', attemptId: string, active: boolean, failureCode: string, failureDetail: string, failedAt: string, replayCount: number, lastReplayedAt: string | null, resolution: string, resolvedAt: string | null }>, pageInfo: { __typename?: 'OperatorPageInfo', hasNextPage: boolean, endCursor: string | null } } };

export type OperatorCircuitsQueryVariables = Exact<{ [key: string]: never; }>;


export type OperatorCircuitsQuery = { __typename?: 'Query', operatorCircuits: Array<{ __typename?: 'OperatorCircuit', state: string, consecutiveFailures: number, openUntil: string | null, updatedAt: string, destination: { __typename?: 'IntegrationArtifactRevision', artifactId: string, revisionId: string, digest: string } }> };

export type OperatorAttemptAuditQueryVariables = Exact<{
  attemptId: Scalars['ID']['input'];
  page: InputMaybe<OperatorPageInput>;
}>;


export type OperatorAttemptAuditQuery = { __typename?: 'Query', operatorAttemptAudit: { __typename?: 'OperatorAuditConnection', nodes: Array<{ __typename?: 'OperatorAuditRecord', auditId: string, attemptId: string, eventKind: string, attemptCount: number, reason: string, recordedAt: string, detail: unknown, principal: { __typename?: 'OperatorPrincipal', id: string, kind: string, authMethod: string, roles: Array<string> } }>, pageInfo: { __typename?: 'OperatorPageInfo', hasNextPage: boolean, endCursor: string | null } } };

export type OperatorDeploymentsQueryVariables = Exact<{ [key: string]: never; }>;


export type OperatorDeploymentsQuery = { __typename?: 'Query', operatorDeployments: Array<{ __typename?: 'OperatorDeployment', state: string, version: number, releaseId: string | null, health: string, validationPassed: boolean, validationExpiresAt: string | null, updatedReason: string, updatedAt: string, definitionRevision: { __typename?: 'IntegrationArtifactRevision', artifactId: string, revisionId: string, digest: string }, updatedBy: { __typename?: 'OperatorPrincipal', id: string, kind: string, authMethod: string, roles: Array<string> } }> };

export type OperatorDeploymentEventsQueryVariables = Exact<{
  definitionId: Scalars['ID']['input'];
  revisionId: Scalars['ID']['input'];
}>;


export type OperatorDeploymentEventsQuery = { __typename?: 'Query', operatorDeploymentEvents: Array<{ __typename?: 'OperatorDeploymentEvent', eventId: string, version: number, action: string, fromState: string, toState: string, health: string, releaseId: string | null, reason: string, occurredAt: string, actor: { __typename?: 'OperatorPrincipal', id: string, kind: string, authMethod: string, roles: Array<string> } }> };

export type OperatorControlResultFieldsFragment = { __typename?: 'OperatorControlResult', kind: string, sourceAttemptId: string, resultAttemptId: string, reason: string, idempotencyKey: string, actor: { __typename?: 'OperatorPrincipal', id: string, kind: string, authMethod: string, roles: Array<string> }, attempt: { __typename?: 'OperatorDeliveryAttempt', tenantId: string, attemptId: string, parentAttemptId: string | null, receiptId: string, eventId: string, traceId: string, route: string, action: string, status: string, attemptCount: number, recordedAt: string, scheduledAt: string, completedAt: string | null, lastErrorCode: string, lastErrorDetail: string, outboxStatus: string, topic: string, leaseOwner: string, leaseExpiresAt: string | null, destination: { __typename?: 'IntegrationPreviewDestination', artifactId: string, revisionId: string, digest: string, class: string }, deadLetter: { __typename?: 'OperatorDeadLetter', attemptId: string, active: boolean, failureCode: string, failureDetail: string, failedAt: string, replayCount: number, lastReplayedAt: string | null, resolution: string, resolvedAt: string | null } | null, deliveries: Array<{ __typename?: 'OperatorDestinationDelivery', transport: string, outcome: string, endpointAdvisory: string, fhirResourceTypes: Array<string>, fhirEntryCount: number, fhirOutcomeCodesAdvisory: Array<string> }> } };

export type ReplayDeliveryMutationVariables = Exact<{
  input: OperatorDeliveryControlInput;
}>;


export type ReplayDeliveryMutation = { __typename?: 'Mutation', replayDelivery: { __typename?: 'OperatorControlResult', kind: string, sourceAttemptId: string, resultAttemptId: string, reason: string, idempotencyKey: string, actor: { __typename?: 'OperatorPrincipal', id: string, kind: string, authMethod: string, roles: Array<string> }, attempt: { __typename?: 'OperatorDeliveryAttempt', tenantId: string, attemptId: string, parentAttemptId: string | null, receiptId: string, eventId: string, traceId: string, route: string, action: string, status: string, attemptCount: number, recordedAt: string, scheduledAt: string, completedAt: string | null, lastErrorCode: string, lastErrorDetail: string, outboxStatus: string, topic: string, leaseOwner: string, leaseExpiresAt: string | null, destination: { __typename?: 'IntegrationPreviewDestination', artifactId: string, revisionId: string, digest: string, class: string }, deadLetter: { __typename?: 'OperatorDeadLetter', attemptId: string, active: boolean, failureCode: string, failureDetail: string, failedAt: string, replayCount: number, lastReplayedAt: string | null, resolution: string, resolvedAt: string | null } | null, deliveries: Array<{ __typename?: 'OperatorDestinationDelivery', transport: string, outcome: string, endpointAdvisory: string, fhirResourceTypes: Array<string>, fhirEntryCount: number, fhirOutcomeCodesAdvisory: Array<string> }> } } };

export type ResubmitMessageMutationVariables = Exact<{
  input: OperatorDeliveryControlInput;
}>;


export type ResubmitMessageMutation = { __typename?: 'Mutation', resubmitMessage: { __typename?: 'OperatorControlResult', kind: string, sourceAttemptId: string, resultAttemptId: string, reason: string, idempotencyKey: string, actor: { __typename?: 'OperatorPrincipal', id: string, kind: string, authMethod: string, roles: Array<string> }, attempt: { __typename?: 'OperatorDeliveryAttempt', tenantId: string, attemptId: string, parentAttemptId: string | null, receiptId: string, eventId: string, traceId: string, route: string, action: string, status: string, attemptCount: number, recordedAt: string, scheduledAt: string, completedAt: string | null, lastErrorCode: string, lastErrorDetail: string, outboxStatus: string, topic: string, leaseOwner: string, leaseExpiresAt: string | null, destination: { __typename?: 'IntegrationPreviewDestination', artifactId: string, revisionId: string, digest: string, class: string }, deadLetter: { __typename?: 'OperatorDeadLetter', attemptId: string, active: boolean, failureCode: string, failureDetail: string, failedAt: string, replayCount: number, lastReplayedAt: string | null, resolution: string, resolvedAt: string | null } | null, deliveries: Array<{ __typename?: 'OperatorDestinationDelivery', transport: string, outcome: string, endpointAdvisory: string, fhirResourceTypes: Array<string>, fhirEntryCount: number, fhirOutcomeCodesAdvisory: Array<string> }> } } };

export type DiscardDeadLetterMutationVariables = Exact<{
  input: OperatorDeliveryControlInput;
}>;


export type DiscardDeadLetterMutation = { __typename?: 'Mutation', discardDeadLetter: { __typename?: 'OperatorControlResult', kind: string, sourceAttemptId: string, resultAttemptId: string, reason: string, idempotencyKey: string, actor: { __typename?: 'OperatorPrincipal', id: string, kind: string, authMethod: string, roles: Array<string> }, attempt: { __typename?: 'OperatorDeliveryAttempt', tenantId: string, attemptId: string, parentAttemptId: string | null, receiptId: string, eventId: string, traceId: string, route: string, action: string, status: string, attemptCount: number, recordedAt: string, scheduledAt: string, completedAt: string | null, lastErrorCode: string, lastErrorDetail: string, outboxStatus: string, topic: string, leaseOwner: string, leaseExpiresAt: string | null, destination: { __typename?: 'IntegrationPreviewDestination', artifactId: string, revisionId: string, digest: string, class: string }, deadLetter: { __typename?: 'OperatorDeadLetter', attemptId: string, active: boolean, failureCode: string, failureDetail: string, failedAt: string, replayCount: number, lastReplayedAt: string | null, resolution: string, resolvedAt: string | null } | null, deliveries: Array<{ __typename?: 'OperatorDestinationDelivery', transport: string, outcome: string, endpointAdvisory: string, fhirResourceTypes: Array<string>, fhirEntryCount: number, fhirOutcomeCodesAdvisory: Array<string> }> } } };

export type PauseIntegrationDeploymentMutationVariables = Exact<{
  input: OperatorDeploymentCommandInput;
}>;


export type PauseIntegrationDeploymentMutation = { __typename?: 'Mutation', pauseIntegrationDeployment: { __typename?: 'OperatorDeployment', state: string, version: number, releaseId: string | null, health: string, validationPassed: boolean, validationExpiresAt: string | null, updatedReason: string, updatedAt: string, definitionRevision: { __typename?: 'IntegrationArtifactRevision', artifactId: string, revisionId: string, digest: string }, updatedBy: { __typename?: 'OperatorPrincipal', id: string, kind: string, authMethod: string, roles: Array<string> } } };

export type ResumeIntegrationDeploymentMutationVariables = Exact<{
  input: OperatorDeploymentCommandInput;
}>;


export type ResumeIntegrationDeploymentMutation = { __typename?: 'Mutation', resumeIntegrationDeployment: { __typename?: 'OperatorDeployment', state: string, version: number, releaseId: string | null, health: string, validationPassed: boolean, validationExpiresAt: string | null, updatedReason: string, updatedAt: string, definitionRevision: { __typename?: 'IntegrationArtifactRevision', artifactId: string, revisionId: string, digest: string }, updatedBy: { __typename?: 'OperatorPrincipal', id: string, kind: string, authMethod: string, roles: Array<string> } } };

export type RetireIntegrationDeploymentMutationVariables = Exact<{
  input: OperatorDeploymentCommandInput;
}>;


export type RetireIntegrationDeploymentMutation = { __typename?: 'Mutation', retireIntegrationDeployment: { __typename?: 'OperatorDeployment', state: string, version: number, releaseId: string | null, health: string, validationPassed: boolean, validationExpiresAt: string | null, updatedReason: string, updatedAt: string, definitionRevision: { __typename?: 'IntegrationArtifactRevision', artifactId: string, revisionId: string, digest: string }, updatedBy: { __typename?: 'OperatorPrincipal', id: string, kind: string, authMethod: string, roles: Array<string> } } };

export type DeployIntegrationReleaseMutationVariables = Exact<{
  input: OperatorDeploymentCommandInput;
}>;


export type DeployIntegrationReleaseMutation = { __typename?: 'Mutation', deployIntegrationRelease: { __typename?: 'OperatorDeployment', state: string, version: number, releaseId: string | null, health: string, validationPassed: boolean, validationExpiresAt: string | null, updatedReason: string, updatedAt: string, definitionRevision: { __typename?: 'IntegrationArtifactRevision', artifactId: string, revisionId: string, digest: string }, updatedBy: { __typename?: 'OperatorPrincipal', id: string, kind: string, authMethod: string, roles: Array<string> } } };
...
export const OperatorPageInfoFieldsFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPageInfoFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPageInfo"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hasNextPage"}},{"kind":"Field","name":{"kind":"Name","value":"endCursor"}}]}}]} as unknown as DocumentNode<OperatorPageInfoFieldsFragment, unknown>;
export const OperatorPrincipalFieldsFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPrincipalFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPrincipal"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"authMethod"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}}]} as unknown as DocumentNode<OperatorPrincipalFieldsFragment, unknown>;
export const OperatorReceiptFieldsFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorReceiptFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorReceipt"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tenantId"}},{"kind":"Field","name":{"kind":"Name","value":"receiptId"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"recordedAt"}},{"kind":"Field","name":{"kind":"Name","value":"correlationId"}},{"kind":"Field","name":{"kind":"Name","value":"rawRetentionMode"}},{"kind":"Field","name":{"kind":"Name","value":"integrationRevision"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}}]}},{"kind":"Field","name":{"kind":"Name","value":"principal"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPrincipalFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"reason"}},{"kind":"Field","name":{"kind":"Name","value":"eventCount"}},{"kind":"Field","name":{"kind":"Name","value":"attemptCount"}},{"kind":"Field","name":{"kind":"Name","value":"failedAttemptCount"}},{"kind":"Field","name":{"kind":"Name","value":"deadLetterCount"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPrincipalFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPrincipal"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"authMethod"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}}]} as unknown as DocumentNode<OperatorReceiptFieldsFragment, unknown>;
export const OperatorAuditFieldsFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorAuditFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorAuditRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"auditId"}},{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"eventKind"}},{"kind":"Field","name":{"kind":"Name","value":"attemptCount"}},{"kind":"Field","name":{"kind":"Name","value":"reason"}},{"kind":"Field","name":{"kind":"Name","value":"recordedAt"}},{"kind":"Field","name":{"kind":"Name","value":"detail"}},{"kind":"Field","name":{"kind":"Name","value":"principal"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPrincipalFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPrincipalFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPrincipal"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"authMethod"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}}]} as unknown as DocumentNode<OperatorAuditFieldsFragment, unknown>;
export const OperatorDeploymentFieldsFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDeploymentFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeployment"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"definitionRevision"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}}]}},{"kind":"Field","name":{"kind":"Name","value":"state"}},{"kind":"Field","name":{"kind":"Name","value":"version"}},{"kind":"Field","name":{"kind":"Name","value":"releaseId"}},{"kind":"Field","name":{"kind":"Name","value":"health"}},{"kind":"Field","name":{"kind":"Name","value":"validationPassed"}},{"kind":"Field","name":{"kind":"Name","value":"validationExpiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedReason"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedBy"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPrincipalFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPrincipalFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPrincipal"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"authMethod"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}}]} as unknown as DocumentNode<OperatorDeploymentFieldsFragment, unknown>;
export const OperatorDeadLetterFieldsFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDeadLetterFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeadLetter"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"active"}},{"kind":"Field","name":{"kind":"Name","value":"failureCode"}},{"kind":"Field","name":{"kind":"Name","value":"failureDetail"}},{"kind":"Field","name":{"kind":"Name","value":"failedAt"}},{"kind":"Field","name":{"kind":"Name","value":"replayCount"}},{"kind":"Field","name":{"kind":"Name","value":"lastReplayedAt"}},{"kind":"Field","name":{"kind":"Name","value":"resolution"}},{"kind":"Field","name":{"kind":"Name","value":"resolvedAt"}}]}}]} as unknown as DocumentNode<OperatorDeadLetterFieldsFragment, unknown>;
export const OperatorDestinationDeliveryFieldsFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDestinationDeliveryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDestinationDelivery"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"transport"}},{"kind":"Field","name":{"kind":"Name","value":"outcome"}},{"kind":"Field","name":{"kind":"Name","value":"endpointAdvisory"}},{"kind":"Field","name":{"kind":"Name","value":"fhirResourceTypes"}},{"kind":"Field","name":{"kind":"Name","value":"fhirEntryCount"}},{"kind":"Field","name":{"kind":"Name","value":"fhirOutcomeCodesAdvisory"}}]}}]} as unknown as DocumentNode<OperatorDestinationDeliveryFieldsFragment, unknown>;
export const OperatorAttemptFieldsFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorAttemptFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeliveryAttempt"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tenantId"}},{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"parentAttemptId"}},{"kind":"Field","name":{"kind":"Name","value":"receiptId"}},{"kind":"Field","name":{"kind":"Name","value":"eventId"}},{"kind":"Field","name":{"kind":"Name","value":"traceId"}},{"kind":"Field","name":{"kind":"Name","value":"destination"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}},{"kind":"Field","name":{"kind":"Name","value":"class"}}]}},{"kind":"Field","name":{"kind":"Name","value":"route"}},{"kind":"Field","name":{"kind":"Name","value":"action"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"attemptCount"}},{"kind":"Field","name":{"kind":"Name","value":"recordedAt"}},{"kind":"Field","name":{"kind":"Name","value":"scheduledAt"}},{"kind":"Field","name":{"kind":"Name","value":"completedAt"}},{"kind":"Field","name":{"kind":"Name","value":"lastErrorCode"}},{"kind":"Field","name":{"kind":"Name","value":"lastErrorDetail"}},{"kind":"Field","name":{"kind":"Name","value":"outboxStatus"}},{"kind":"Field","name":{"kind":"Name","value":"topic"}},{"kind":"Field","name":{"kind":"Name","value":"leaseOwner"}},{"kind":"Field","name":{"kind":"Name","value":"leaseExpiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"deadLetter"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDeadLetterFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"deliveries"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDestinationDeliveryFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDeadLetterFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeadLetter"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"active"}},{"kind":"Field","name":{"kind":"Name","value":"failureCode"}},{"kind":"Field","name":{"kind":"Name","value":"failureDetail"}},{"kind":"Field","name":{"kind":"Name","value":"failedAt"}},{"kind":"Field","name":{"kind":"Name","value":"replayCount"}},{"kind":"Field","name":{"kind":"Name","value":"lastReplayedAt"}},{"kind":"Field","name":{"kind":"Name","value":"resolution"}},{"kind":"Field","name":{"kind":"Name","value":"resolvedAt"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDestinationDeliveryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDestinationDelivery"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"transport"}},{"kind":"Field","name":{"kind":"Name","value":"outcome"}},{"kind":"Field","name":{"kind":"Name","value":"endpointAdvisory"}},{"kind":"Field","name":{"kind":"Name","value":"fhirResourceTypes"}},{"kind":"Field","name":{"kind":"Name","value":"fhirEntryCount"}},{"kind":"Field","name":{"kind":"Name","value":"fhirOutcomeCodesAdvisory"}}]}}]} as unknown as DocumentNode<OperatorAttemptFieldsFragment, unknown>;
export const OperatorControlResultFieldsFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorControlResultFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorControlResult"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"sourceAttemptId"}},{"kind":"Field","name":{"kind":"Name","value":"resultAttemptId"}},{"kind":"Field","name":{"kind":"Name","value":"reason"}},{"kind":"Field","name":{"kind":"Name","value":"idempotencyKey"}},{"kind":"Field","name":{"kind":"Name","value":"actor"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPrincipalFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"attempt"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorAttemptFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDeadLetterFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeadLetter"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"active"}},{"kind":"Field","name":{"kind":"Name","value":"failureCode"}},{"kind":"Field","name":{"kind":"Name","value":"failureDetail"}},{"kind":"Field","name":{"kind":"Name","value":"failedAt"}},{"kind":"Field","name":{"kind":"Name","value":"replayCount"}},{"kind":"Field","name":{"kind":"Name","value":"lastReplayedAt"}},{"kind":"Field","name":{"kind":"Name","value":"resolution"}},{"kind":"Field","name":{"kind":"Name","value":"resolvedAt"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDestinationDeliveryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDestinationDelivery"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"transport"}},{"kind":"Field","name":{"kind":"Name","value":"outcome"}},{"kind":"Field","name":{"kind":"Name","value":"endpointAdvisory"}},{"kind":"Field","name":{"kind":"Name","value":"fhirResourceTypes"}},{"kind":"Field","name":{"kind":"Name","value":"fhirEntryCount"}},{"kind":"Field","name":{"kind":"Name","value":"fhirOutcomeCodesAdvisory"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPrincipalFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPrincipal"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"authMethod"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorAttemptFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeliveryAttempt"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tenantId"}},{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"parentAttemptId"}},{"kind":"Field","name":{"kind":"Name","value":"receiptId"}},{"kind":"Field","name":{"kind":"Name","value":"eventId"}},{"kind":"Field","name":{"kind":"Name","value":"traceId"}},{"kind":"Field","name":{"kind":"Name","value":"destination"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}},{"kind":"Field","name":{"kind":"Name","value":"class"}}]}},{"kind":"Field","name":{"kind":"Name","value":"route"}},{"kind":"Field","name":{"kind":"Name","value":"action"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"attemptCount"}},{"kind":"Field","name":{"kind":"Name","value":"recordedAt"}},{"kind":"Field","name":{"kind":"Name","value":"scheduledAt"}},{"kind":"Field","name":{"kind":"Name","value":"completedAt"}},{"kind":"Field","name":{"kind":"Name","value":"lastErrorCode"}},{"kind":"Field","name":{"kind":"Name","value":"lastErrorDetail"}},{"kind":"Field","name":{"kind":"Name","value":"outboxStatus"}},{"kind":"Field","name":{"kind":"Name","value":"topic"}},{"kind":"Field","name":{"kind":"Name","value":"leaseOwner"}},{"kind":"Field","name":{"kind":"Name","value":"leaseExpiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"deadLetter"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDeadLetterFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"deliveries"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDestinationDeliveryFields"}}]}}]}}]} as unknown as DocumentNode<OperatorControlResultFieldsFragment, unknown>;
...
export const HomeRecentSessionsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"HomeRecentSessions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"integrationSessions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"runs"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]}}]}}]} as unknown as DocumentNode<HomeRecentSessionsQuery, HomeRecentSessionsQueryVariables>;
...
export const OperatorReceiptsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"OperatorReceipts"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"filter"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorReceiptFilter"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"page"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPageInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"operatorReceipts"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"filter"},"value":{"kind":"Variable","name":{"kind":"Name","value":"filter"}}},{"kind":"Argument","name":{"kind":"Name","value":"page"},"value":{"kind":"Variable","name":{"kind":"Name","value":"page"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorReceiptFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"pageInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPageInfoFields"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPrincipalFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPrincipal"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"authMethod"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorReceiptFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorReceipt"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tenantId"}},{"kind":"Field","name":{"kind":"Name","value":"receiptId"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"recordedAt"}},{"kind":"Field","name":{"kind":"Name","value":"correlationId"}},{"kind":"Field","name":{"kind":"Name","value":"rawRetentionMode"}},{"kind":"Field","name":{"kind":"Name","value":"integrationRevision"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}}]}},{"kind":"Field","name":{"kind":"Name","value":"principal"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPrincipalFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"reason"}},{"kind":"Field","name":{"kind":"Name","value":"eventCount"}},{"kind":"Field","name":{"kind":"Name","value":"attemptCount"}},{"kind":"Field","name":{"kind":"Name","value":"failedAttemptCount"}},{"kind":"Field","name":{"kind":"Name","value":"deadLetterCount"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPageInfoFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPageInfo"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hasNextPage"}},{"kind":"Field","name":{"kind":"Name","value":"endCursor"}}]}}]} as unknown as DocumentNode<OperatorReceiptsQuery, OperatorReceiptsQueryVariables>;
export const OperatorMessageTraceDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"OperatorMessageTrace"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"receiptId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"operatorMessageTrace"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"receiptId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"receiptId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"receipt"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorReceiptFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"events"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"eventId"}},{"kind":"Field","name":{"kind":"Name","value":"receiptId"}},{"kind":"Field","name":{"kind":"Name","value":"eventType"}},{"kind":"Field","name":{"kind":"Name","value":"sourceMessageId"}},{"kind":"Field","name":{"kind":"Name","value":"correlationId"}},{"kind":"Field","name":{"kind":"Name","value":"classification"}},{"kind":"Field","name":{"kind":"Name","value":"recordedAt"}},{"kind":"Field","name":{"kind":"Name","value":"payloadTruncated"}},{"kind":"Field","name":{"kind":"Name","value":"payloadFields"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"path"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"repeated"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"lineage"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"lineageId"}},{"kind":"Field","name":{"kind":"Name","value":"receiptId"}},{"kind":"Field","name":{"kind":"Name","value":"eventId"}},{"kind":"Field","name":{"kind":"Name","value":"traceId"}},{"kind":"Field","name":{"kind":"Name","value":"correlationId"}},{"kind":"Field","name":{"kind":"Name","value":"sourceMessageId"}},{"kind":"Field","name":{"kind":"Name","value":"recordedAt"}},{"kind":"Field","name":{"kind":"Name","value":"artifactRevisions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"source"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}}]}},{"kind":"Field","name":{"kind":"Name","value":"profile"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}}]}},{"kind":"Field","name":{"kind":"Name","value":"workflow"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"routes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"route"}},{"kind":"Field","name":{"kind":"Name","value":"matched"}},{"kind":"Field","name":{"kind":"Name","value":"skipped"}},{"kind":"Field","name":{"kind":"Name","value":"skipReason"}},{"kind":"Field","name":{"kind":"Name","value":"transformCount"}},{"kind":"Field","name":{"kind":"Name","value":"plannedActions"}},{"kind":"Field","name":{"kind":"Name","value":"diagnosticCodes"}}]}},{"kind":"Field","name":{"kind":"Name","value":"diagnostics"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"severity"}},{"kind":"Field","name":{"kind":"Name","value":"stage"}},{"kind":"Field","name":{"kind":"Name","value":"code"}},{"kind":"Field","name":{"kind":"Name","value":"path"}},{"kind":"Field","name":{"kind":"Name","value":"classification"}}]}}]}},{"kind":"Field","name":{"kind":"Name","value":"attempts"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorAttemptFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"audit"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorAuditFields"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPrincipalFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPrincipal"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"authMethod"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDeadLetterFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeadLetter"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"active"}},{"kind":"Field","name":{"kind":"Name","value":"failureCode"}},{"kind":"Field","name":{"kind":"Name","value":"failureDetail"}},{"kind":"Field","name":{"kind":"Name","value":"failedAt"}},{"kind":"Field","name":{"kind":"Name","value":"replayCount"}},{"kind":"Field","name":{"kind":"Name","value":"lastReplayedAt"}},{"kind":"Field","name":{"kind":"Name","value":"resolution"}},{"kind":"Field","name":{"kind":"Name","value":"resolvedAt"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDestinationDeliveryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDestinationDelivery"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"transport"}},{"kind":"Field","name":{"kind":"Name","value":"outcome"}},{"kind":"Field","name":{"kind":"Name","value":"endpointAdvisory"}},{"kind":"Field","name":{"kind":"Name","value":"fhirResourceTypes"}},{"kind":"Field","name":{"kind":"Name","value":"fhirEntryCount"}},{"kind":"Field","name":{"kind":"Name","value":"fhirOutcomeCodesAdvisory"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorReceiptFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorReceipt"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tenantId"}},{"kind":"Field","name":{"kind":"Name","value":"receiptId"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"recordedAt"}},{"kind":"Field","name":{"kind":"Name","value":"correlationId"}},{"kind":"Field","name":{"kind":"Name","value":"rawRetentionMode"}},{"kind":"Field","name":{"kind":"Name","value":"integrationRevision"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}}]}},{"kind":"Field","name":{"kind":"Name","value":"principal"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPrincipalFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"reason"}},{"kind":"Field","name":{"kind":"Name","value":"eventCount"}},{"kind":"Field","name":{"kind":"Name","value":"attemptCount"}},{"kind":"Field","name":{"kind":"Name","value":"failedAttemptCount"}},{"kind":"Field","name":{"kind":"Name","value":"deadLetterCount"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorAttemptFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeliveryAttempt"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tenantId"}},{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"parentAttemptId"}},{"kind":"Field","name":{"kind":"Name","value":"receiptId"}},{"kind":"Field","name":{"kind":"Name","value":"eventId"}},{"kind":"Field","name":{"kind":"Name","value":"traceId"}},{"kind":"Field","name":{"kind":"Name","value":"destination"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}},{"kind":"Field","name":{"kind":"Name","value":"class"}}]}},{"kind":"Field","name":{"kind":"Name","value":"route"}},{"kind":"Field","name":{"kind":"Name","value":"action"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"attemptCount"}},{"kind":"Field","name":{"kind":"Name","value":"recordedAt"}},{"kind":"Field","name":{"kind":"Name","value":"scheduledAt"}},{"kind":"Field","name":{"kind":"Name","value":"completedAt"}},{"kind":"Field","name":{"kind":"Name","value":"lastErrorCode"}},{"kind":"Field","name":{"kind":"Name","value":"lastErrorDetail"}},{"kind":"Field","name":{"kind":"Name","value":"outboxStatus"}},{"kind":"Field","name":{"kind":"Name","value":"topic"}},{"kind":"Field","name":{"kind":"Name","value":"leaseOwner"}},{"kind":"Field","name":{"kind":"Name","value":"leaseExpiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"deadLetter"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDeadLetterFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"deliveries"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDestinationDeliveryFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorAuditFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorAuditRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"auditId"}},{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"eventKind"}},{"kind":"Field","name":{"kind":"Name","value":"attemptCount"}},{"kind":"Field","name":{"kind":"Name","value":"reason"}},{"kind":"Field","name":{"kind":"Name","value":"recordedAt"}},{"kind":"Field","name":{"kind":"Name","value":"detail"}},{"kind":"Field","name":{"kind":"Name","value":"principal"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPrincipalFields"}}]}}]}}]} as unknown as DocumentNode<OperatorMessageTraceQuery, OperatorMessageTraceQueryVariables>;
export const OperatorDeliveryAttemptDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"OperatorDeliveryAttempt"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"attemptId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"operatorDeliveryAttempt"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"attemptId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"attemptId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorAttemptFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDeadLetterFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeadLetter"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"active"}},{"kind":"Field","name":{"kind":"Name","value":"failureCode"}},{"kind":"Field","name":{"kind":"Name","value":"failureDetail"}},{"kind":"Field","name":{"kind":"Name","value":"failedAt"}},{"kind":"Field","name":{"kind":"Name","value":"replayCount"}},{"kind":"Field","name":{"kind":"Name","value":"lastReplayedAt"}},{"kind":"Field","name":{"kind":"Name","value":"resolution"}},{"kind":"Field","name":{"kind":"Name","value":"resolvedAt"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDestinationDeliveryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDestinationDelivery"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"transport"}},{"kind":"Field","name":{"kind":"Name","value":"outcome"}},{"kind":"Field","name":{"kind":"Name","value":"endpointAdvisory"}},{"kind":"Field","name":{"kind":"Name","value":"fhirResourceTypes"}},{"kind":"Field","name":{"kind":"Name","value":"fhirEntryCount"}},{"kind":"Field","name":{"kind":"Name","value":"fhirOutcomeCodesAdvisory"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorAttemptFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeliveryAttempt"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tenantId"}},{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"parentAttemptId"}},{"kind":"Field","name":{"kind":"Name","value":"receiptId"}},{"kind":"Field","name":{"kind":"Name","value":"eventId"}},{"kind":"Field","name":{"kind":"Name","value":"traceId"}},{"kind":"Field","name":{"kind":"Name","value":"destination"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}},{"kind":"Field","name":{"kind":"Name","value":"class"}}]}},{"kind":"Field","name":{"kind":"Name","value":"route"}},{"kind":"Field","name":{"kind":"Name","value":"action"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"attemptCount"}},{"kind":"Field","name":{"kind":"Name","value":"recordedAt"}},{"kind":"Field","name":{"kind":"Name","value":"scheduledAt"}},{"kind":"Field","name":{"kind":"Name","value":"completedAt"}},{"kind":"Field","name":{"kind":"Name","value":"lastErrorCode"}},{"kind":"Field","name":{"kind":"Name","value":"lastErrorDetail"}},{"kind":"Field","name":{"kind":"Name","value":"outboxStatus"}},{"kind":"Field","name":{"kind":"Name","value":"topic"}},{"kind":"Field","name":{"kind":"Name","value":"leaseOwner"}},{"kind":"Field","name":{"kind":"Name","value":"leaseExpiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"deadLetter"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDeadLetterFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"deliveries"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDestinationDeliveryFields"}}]}}]}}]} as unknown as DocumentNode<OperatorDeliveryAttemptQuery, OperatorDeliveryAttemptQueryVariables>;
export const OperatorDeliveryAttemptsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"OperatorDeliveryAttempts"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"filter"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorAttemptFilter"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"page"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPageInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"operatorDeliveryAttempts"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"filter"},"value":{"kind":"Variable","name":{"kind":"Name","value":"filter"}}},{"kind":"Argument","name":{"kind":"Name","value":"page"},"value":{"kind":"Variable","name":{"kind":"Name","value":"page"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorAttemptFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"pageInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPageInfoFields"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDeadLetterFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeadLetter"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"active"}},{"kind":"Field","name":{"kind":"Name","value":"failureCode"}},{"kind":"Field","name":{"kind":"Name","value":"failureDetail"}},{"kind":"Field","name":{"kind":"Name","value":"failedAt"}},{"kind":"Field","name":{"kind":"Name","value":"replayCount"}},{"kind":"Field","name":{"kind":"Name","value":"lastReplayedAt"}},{"kind":"Field","name":{"kind":"Name","value":"resolution"}},{"kind":"Field","name":{"kind":"Name","value":"resolvedAt"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDestinationDeliveryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDestinationDelivery"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"transport"}},{"kind":"Field","name":{"kind":"Name","value":"outcome"}},{"kind":"Field","name":{"kind":"Name","value":"endpointAdvisory"}},{"kind":"Field","name":{"kind":"Name","value":"fhirResourceTypes"}},{"kind":"Field","name":{"kind":"Name","value":"fhirEntryCount"}},{"kind":"Field","name":{"kind":"Name","value":"fhirOutcomeCodesAdvisory"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorAttemptFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeliveryAttempt"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tenantId"}},{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"parentAttemptId"}},{"kind":"Field","name":{"kind":"Name","value":"receiptId"}},{"kind":"Field","name":{"kind":"Name","value":"eventId"}},{"kind":"Field","name":{"kind":"Name","value":"traceId"}},{"kind":"Field","name":{"kind":"Name","value":"destination"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}},{"kind":"Field","name":{"kind":"Name","value":"class"}}]}},{"kind":"Field","name":{"kind":"Name","value":"route"}},{"kind":"Field","name":{"kind":"Name","value":"action"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"attemptCount"}},{"kind":"Field","name":{"kind":"Name","value":"recordedAt"}},{"kind":"Field","name":{"kind":"Name","value":"scheduledAt"}},{"kind":"Field","name":{"kind":"Name","value":"completedAt"}},{"kind":"Field","name":{"kind":"Name","value":"lastErrorCode"}},{"kind":"Field","name":{"kind":"Name","value":"lastErrorDetail"}},{"kind":"Field","name":{"kind":"Name","value":"outboxStatus"}},{"kind":"Field","name":{"kind":"Name","value":"topic"}},{"kind":"Field","name":{"kind":"Name","value":"leaseOwner"}},{"kind":"Field","name":{"kind":"Name","value":"leaseExpiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"deadLetter"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDeadLetterFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"deliveries"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDestinationDeliveryFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPageInfoFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPageInfo"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hasNextPage"}},{"kind":"Field","name":{"kind":"Name","value":"endCursor"}}]}}]} as unknown as DocumentNode<OperatorDeliveryAttemptsQuery, OperatorDeliveryAttemptsQueryVariables>;
export const OperatorDeadLettersDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"OperatorDeadLetters"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"activeOnly"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Boolean"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"page"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPageInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"operatorDeadLetters"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"activeOnly"},"value":{"kind":"Variable","name":{"kind":"Name","value":"activeOnly"}}},{"kind":"Argument","name":{"kind":"Name","value":"page"},"value":{"kind":"Variable","name":{"kind":"Name","value":"page"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDeadLetterFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"pageInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPageInfoFields"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDeadLetterFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeadLetter"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"active"}},{"kind":"Field","name":{"kind":"Name","value":"failureCode"}},{"kind":"Field","name":{"kind":"Name","value":"failureDetail"}},{"kind":"Field","name":{"kind":"Name","value":"failedAt"}},{"kind":"Field","name":{"kind":"Name","value":"replayCount"}},{"kind":"Field","name":{"kind":"Name","value":"lastReplayedAt"}},{"kind":"Field","name":{"kind":"Name","value":"resolution"}},{"kind":"Field","name":{"kind":"Name","value":"resolvedAt"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPageInfoFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPageInfo"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hasNextPage"}},{"kind":"Field","name":{"kind":"Name","value":"endCursor"}}]}}]} as unknown as DocumentNode<OperatorDeadLettersQuery, OperatorDeadLettersQueryVariables>;
export const OperatorCircuitsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"OperatorCircuits"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"operatorCircuits"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"state"}},{"kind":"Field","name":{"kind":"Name","value":"consecutiveFailures"}},{"kind":"Field","name":{"kind":"Name","value":"openUntil"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"destination"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}}]}}]}}]}}]} as unknown as DocumentNode<OperatorCircuitsQuery, OperatorCircuitsQueryVariables>;
export const OperatorAttemptAuditDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"OperatorAttemptAudit"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"attemptId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"page"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPageInput"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"operatorAttemptAudit"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"attemptId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"attemptId"}}},{"kind":"Argument","name":{"kind":"Name","value":"page"},"value":{"kind":"Variable","name":{"kind":"Name","value":"page"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"nodes"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorAuditFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"pageInfo"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPageInfoFields"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPrincipalFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPrincipal"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"authMethod"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorAuditFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorAuditRecord"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"auditId"}},{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"eventKind"}},{"kind":"Field","name":{"kind":"Name","value":"attemptCount"}},{"kind":"Field","name":{"kind":"Name","value":"reason"}},{"kind":"Field","name":{"kind":"Name","value":"recordedAt"}},{"kind":"Field","name":{"kind":"Name","value":"detail"}},{"kind":"Field","name":{"kind":"Name","value":"principal"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPrincipalFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPageInfoFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPageInfo"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"hasNextPage"}},{"kind":"Field","name":{"kind":"Name","value":"endCursor"}}]}}]} as unknown as DocumentNode<OperatorAttemptAuditQuery, OperatorAttemptAuditQueryVariables>;
export const OperatorDeploymentsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"OperatorDeployments"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"operatorDeployments"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDeploymentFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPrincipalFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPrincipal"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"authMethod"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDeploymentFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeployment"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"definitionRevision"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}}]}},{"kind":"Field","name":{"kind":"Name","value":"state"}},{"kind":"Field","name":{"kind":"Name","value":"version"}},{"kind":"Field","name":{"kind":"Name","value":"releaseId"}},{"kind":"Field","name":{"kind":"Name","value":"health"}},{"kind":"Field","name":{"kind":"Name","value":"validationPassed"}},{"kind":"Field","name":{"kind":"Name","value":"validationExpiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedReason"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedBy"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPrincipalFields"}}]}}]}}]} as unknown as DocumentNode<OperatorDeploymentsQuery, OperatorDeploymentsQueryVariables>;
export const OperatorDeploymentEventsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"OperatorDeploymentEvents"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"definitionId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"revisionId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"operatorDeploymentEvents"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"definitionId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"definitionId"}}},{"kind":"Argument","name":{"kind":"Name","value":"revisionId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"revisionId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"eventId"}},{"kind":"Field","name":{"kind":"Name","value":"version"}},{"kind":"Field","name":{"kind":"Name","value":"action"}},{"kind":"Field","name":{"kind":"Name","value":"fromState"}},{"kind":"Field","name":{"kind":"Name","value":"toState"}},{"kind":"Field","name":{"kind":"Name","value":"health"}},{"kind":"Field","name":{"kind":"Name","value":"releaseId"}},{"kind":"Field","name":{"kind":"Name","value":"reason"}},{"kind":"Field","name":{"kind":"Name","value":"occurredAt"}},{"kind":"Field","name":{"kind":"Name","value":"actor"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPrincipalFields"}}]}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPrincipalFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPrincipal"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"authMethod"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}}]} as unknown as DocumentNode<OperatorDeploymentEventsQuery, OperatorDeploymentEventsQueryVariables>;
export const ReplayDeliveryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ReplayDelivery"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeliveryControlInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"replayDelivery"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorControlResultFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPrincipalFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPrincipal"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"authMethod"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDeadLetterFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeadLetter"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"active"}},{"kind":"Field","name":{"kind":"Name","value":"failureCode"}},{"kind":"Field","name":{"kind":"Name","value":"failureDetail"}},{"kind":"Field","name":{"kind":"Name","value":"failedAt"}},{"kind":"Field","name":{"kind":"Name","value":"replayCount"}},{"kind":"Field","name":{"kind":"Name","value":"lastReplayedAt"}},{"kind":"Field","name":{"kind":"Name","value":"resolution"}},{"kind":"Field","name":{"kind":"Name","value":"resolvedAt"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDestinationDeliveryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDestinationDelivery"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"transport"}},{"kind":"Field","name":{"kind":"Name","value":"outcome"}},{"kind":"Field","name":{"kind":"Name","value":"endpointAdvisory"}},{"kind":"Field","name":{"kind":"Name","value":"fhirResourceTypes"}},{"kind":"Field","name":{"kind":"Name","value":"fhirEntryCount"}},{"kind":"Field","name":{"kind":"Name","value":"fhirOutcomeCodesAdvisory"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorAttemptFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeliveryAttempt"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tenantId"}},{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"parentAttemptId"}},{"kind":"Field","name":{"kind":"Name","value":"receiptId"}},{"kind":"Field","name":{"kind":"Name","value":"eventId"}},{"kind":"Field","name":{"kind":"Name","value":"traceId"}},{"kind":"Field","name":{"kind":"Name","value":"destination"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}},{"kind":"Field","name":{"kind":"Name","value":"class"}}]}},{"kind":"Field","name":{"kind":"Name","value":"route"}},{"kind":"Field","name":{"kind":"Name","value":"action"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"attemptCount"}},{"kind":"Field","name":{"kind":"Name","value":"recordedAt"}},{"kind":"Field","name":{"kind":"Name","value":"scheduledAt"}},{"kind":"Field","name":{"kind":"Name","value":"completedAt"}},{"kind":"Field","name":{"kind":"Name","value":"lastErrorCode"}},{"kind":"Field","name":{"kind":"Name","value":"lastErrorDetail"}},{"kind":"Field","name":{"kind":"Name","value":"outboxStatus"}},{"kind":"Field","name":{"kind":"Name","value":"topic"}},{"kind":"Field","name":{"kind":"Name","value":"leaseOwner"}},{"kind":"Field","name":{"kind":"Name","value":"leaseExpiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"deadLetter"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDeadLetterFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"deliveries"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDestinationDeliveryFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorControlResultFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorControlResult"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"sourceAttemptId"}},{"kind":"Field","name":{"kind":"Name","value":"resultAttemptId"}},{"kind":"Field","name":{"kind":"Name","value":"reason"}},{"kind":"Field","name":{"kind":"Name","value":"idempotencyKey"}},{"kind":"Field","name":{"kind":"Name","value":"actor"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPrincipalFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"attempt"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorAttemptFields"}}]}}]}}]} as unknown as DocumentNode<ReplayDeliveryMutation, ReplayDeliveryMutationVariables>;
export const ResubmitMessageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ResubmitMessage"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeliveryControlInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"resubmitMessage"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorControlResultFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPrincipalFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPrincipal"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"authMethod"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDeadLetterFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeadLetter"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"active"}},{"kind":"Field","name":{"kind":"Name","value":"failureCode"}},{"kind":"Field","name":{"kind":"Name","value":"failureDetail"}},{"kind":"Field","name":{"kind":"Name","value":"failedAt"}},{"kind":"Field","name":{"kind":"Name","value":"replayCount"}},{"kind":"Field","name":{"kind":"Name","value":"lastReplayedAt"}},{"kind":"Field","name":{"kind":"Name","value":"resolution"}},{"kind":"Field","name":{"kind":"Name","value":"resolvedAt"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDestinationDeliveryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDestinationDelivery"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"transport"}},{"kind":"Field","name":{"kind":"Name","value":"outcome"}},{"kind":"Field","name":{"kind":"Name","value":"endpointAdvisory"}},{"kind":"Field","name":{"kind":"Name","value":"fhirResourceTypes"}},{"kind":"Field","name":{"kind":"Name","value":"fhirEntryCount"}},{"kind":"Field","name":{"kind":"Name","value":"fhirOutcomeCodesAdvisory"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorAttemptFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeliveryAttempt"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tenantId"}},{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"parentAttemptId"}},{"kind":"Field","name":{"kind":"Name","value":"receiptId"}},{"kind":"Field","name":{"kind":"Name","value":"eventId"}},{"kind":"Field","name":{"kind":"Name","value":"traceId"}},{"kind":"Field","name":{"kind":"Name","value":"destination"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}},{"kind":"Field","name":{"kind":"Name","value":"class"}}]}},{"kind":"Field","name":{"kind":"Name","value":"route"}},{"kind":"Field","name":{"kind":"Name","value":"action"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"attemptCount"}},{"kind":"Field","name":{"kind":"Name","value":"recordedAt"}},{"kind":"Field","name":{"kind":"Name","value":"scheduledAt"}},{"kind":"Field","name":{"kind":"Name","value":"completedAt"}},{"kind":"Field","name":{"kind":"Name","value":"lastErrorCode"}},{"kind":"Field","name":{"kind":"Name","value":"lastErrorDetail"}},{"kind":"Field","name":{"kind":"Name","value":"outboxStatus"}},{"kind":"Field","name":{"kind":"Name","value":"topic"}},{"kind":"Field","name":{"kind":"Name","value":"leaseOwner"}},{"kind":"Field","name":{"kind":"Name","value":"leaseExpiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"deadLetter"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDeadLetterFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"deliveries"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDestinationDeliveryFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorControlResultFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorControlResult"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"sourceAttemptId"}},{"kind":"Field","name":{"kind":"Name","value":"resultAttemptId"}},{"kind":"Field","name":{"kind":"Name","value":"reason"}},{"kind":"Field","name":{"kind":"Name","value":"idempotencyKey"}},{"kind":"Field","name":{"kind":"Name","value":"actor"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPrincipalFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"attempt"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorAttemptFields"}}]}}]}}]} as unknown as DocumentNode<ResubmitMessageMutation, ResubmitMessageMutationVariables>;
export const DiscardDeadLetterDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DiscardDeadLetter"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeliveryControlInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"discardDeadLetter"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorControlResultFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPrincipalFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPrincipal"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"authMethod"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDeadLetterFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeadLetter"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"active"}},{"kind":"Field","name":{"kind":"Name","value":"failureCode"}},{"kind":"Field","name":{"kind":"Name","value":"failureDetail"}},{"kind":"Field","name":{"kind":"Name","value":"failedAt"}},{"kind":"Field","name":{"kind":"Name","value":"replayCount"}},{"kind":"Field","name":{"kind":"Name","value":"lastReplayedAt"}},{"kind":"Field","name":{"kind":"Name","value":"resolution"}},{"kind":"Field","name":{"kind":"Name","value":"resolvedAt"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDestinationDeliveryFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDestinationDelivery"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"transport"}},{"kind":"Field","name":{"kind":"Name","value":"outcome"}},{"kind":"Field","name":{"kind":"Name","value":"endpointAdvisory"}},{"kind":"Field","name":{"kind":"Name","value":"fhirResourceTypes"}},{"kind":"Field","name":{"kind":"Name","value":"fhirEntryCount"}},{"kind":"Field","name":{"kind":"Name","value":"fhirOutcomeCodesAdvisory"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorAttemptFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeliveryAttempt"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tenantId"}},{"kind":"Field","name":{"kind":"Name","value":"attemptId"}},{"kind":"Field","name":{"kind":"Name","value":"parentAttemptId"}},{"kind":"Field","name":{"kind":"Name","value":"receiptId"}},{"kind":"Field","name":{"kind":"Name","value":"eventId"}},{"kind":"Field","name":{"kind":"Name","value":"traceId"}},{"kind":"Field","name":{"kind":"Name","value":"destination"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}},{"kind":"Field","name":{"kind":"Name","value":"class"}}]}},{"kind":"Field","name":{"kind":"Name","value":"route"}},{"kind":"Field","name":{"kind":"Name","value":"action"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"attemptCount"}},{"kind":"Field","name":{"kind":"Name","value":"recordedAt"}},{"kind":"Field","name":{"kind":"Name","value":"scheduledAt"}},{"kind":"Field","name":{"kind":"Name","value":"completedAt"}},{"kind":"Field","name":{"kind":"Name","value":"lastErrorCode"}},{"kind":"Field","name":{"kind":"Name","value":"lastErrorDetail"}},{"kind":"Field","name":{"kind":"Name","value":"outboxStatus"}},{"kind":"Field","name":{"kind":"Name","value":"topic"}},{"kind":"Field","name":{"kind":"Name","value":"leaseOwner"}},{"kind":"Field","name":{"kind":"Name","value":"leaseExpiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"deadLetter"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDeadLetterFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"deliveries"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDestinationDeliveryFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorControlResultFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorControlResult"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"sourceAttemptId"}},{"kind":"Field","name":{"kind":"Name","value":"resultAttemptId"}},{"kind":"Field","name":{"kind":"Name","value":"reason"}},{"kind":"Field","name":{"kind":"Name","value":"idempotencyKey"}},{"kind":"Field","name":{"kind":"Name","value":"actor"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPrincipalFields"}}]}},{"kind":"Field","name":{"kind":"Name","value":"attempt"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorAttemptFields"}}]}}]}}]} as unknown as DocumentNode<DiscardDeadLetterMutation, DiscardDeadLetterMutationVariables>;
export const PauseIntegrationDeploymentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"PauseIntegrationDeployment"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeploymentCommandInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"pauseIntegrationDeployment"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDeploymentFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPrincipalFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPrincipal"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"authMethod"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDeploymentFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeployment"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"definitionRevision"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}}]}},{"kind":"Field","name":{"kind":"Name","value":"state"}},{"kind":"Field","name":{"kind":"Name","value":"version"}},{"kind":"Field","name":{"kind":"Name","value":"releaseId"}},{"kind":"Field","name":{"kind":"Name","value":"health"}},{"kind":"Field","name":{"kind":"Name","value":"validationPassed"}},{"kind":"Field","name":{"kind":"Name","value":"validationExpiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedReason"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedBy"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPrincipalFields"}}]}}]}}]} as unknown as DocumentNode<PauseIntegrationDeploymentMutation, PauseIntegrationDeploymentMutationVariables>;
export const ResumeIntegrationDeploymentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ResumeIntegrationDeployment"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeploymentCommandInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"resumeIntegrationDeployment"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDeploymentFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPrincipalFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPrincipal"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"authMethod"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDeploymentFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeployment"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"definitionRevision"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}}]}},{"kind":"Field","name":{"kind":"Name","value":"state"}},{"kind":"Field","name":{"kind":"Name","value":"version"}},{"kind":"Field","name":{"kind":"Name","value":"releaseId"}},{"kind":"Field","name":{"kind":"Name","value":"health"}},{"kind":"Field","name":{"kind":"Name","value":"validationPassed"}},{"kind":"Field","name":{"kind":"Name","value":"validationExpiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedReason"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedBy"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPrincipalFields"}}]}}]}}]} as unknown as DocumentNode<ResumeIntegrationDeploymentMutation, ResumeIntegrationDeploymentMutationVariables>;
export const RetireIntegrationDeploymentDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RetireIntegrationDeployment"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeploymentCommandInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"retireIntegrationDeployment"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDeploymentFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPrincipalFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPrincipal"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"authMethod"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDeploymentFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeployment"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"definitionRevision"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}}]}},{"kind":"Field","name":{"kind":"Name","value":"state"}},{"kind":"Field","name":{"kind":"Name","value":"version"}},{"kind":"Field","name":{"kind":"Name","value":"releaseId"}},{"kind":"Field","name":{"kind":"Name","value":"health"}},{"kind":"Field","name":{"kind":"Name","value":"validationPassed"}},{"kind":"Field","name":{"kind":"Name","value":"validationExpiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedReason"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedBy"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPrincipalFields"}}]}}]}}]} as unknown as DocumentNode<RetireIntegrationDeploymentMutation, RetireIntegrationDeploymentMutationVariables>;
export const DeployIntegrationReleaseDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"DeployIntegrationRelease"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeploymentCommandInput"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deployIntegrationRelease"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorDeploymentFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorPrincipalFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorPrincipal"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"authMethod"}},{"kind":"Field","name":{"kind":"Name","value":"roles"}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"OperatorDeploymentFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"OperatorDeployment"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"definitionRevision"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"artifactId"}},{"kind":"Field","name":{"kind":"Name","value":"revisionId"}},{"kind":"Field","name":{"kind":"Name","value":"digest"}}]}},{"kind":"Field","name":{"kind":"Name","value":"state"}},{"kind":"Field","name":{"kind":"Name","value":"version"}},{"kind":"Field","name":{"kind":"Name","value":"releaseId"}},{"kind":"Field","name":{"kind":"Name","value":"health"}},{"kind":"Field","name":{"kind":"Name","value":"validationPassed"}},{"kind":"Field","name":{"kind":"Name","value":"validationExpiresAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedReason"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedBy"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"OperatorPrincipalFields"}}]}}]}}]} as unknown as DocumentNode<DeployIntegrationReleaseMutation, DeployIntegrationReleaseMutationVariables>;
