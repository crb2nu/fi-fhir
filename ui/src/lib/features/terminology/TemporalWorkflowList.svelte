...
<style>
  ...
  .stat-value.running { color: rgba(251, 191, 36, 0.9); }
  .stat-value.completed { color: rgba(34, 197, 94, 0.9); }
  .stat-value.failed { color: rgba(239, 68, 68, 0.9); }
  .stat-value.canceled { color: rgba(229, 231, 235, 0.5); }
